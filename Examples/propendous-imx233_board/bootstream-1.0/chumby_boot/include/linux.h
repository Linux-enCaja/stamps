...
#define DEFAULT_LINUX_CMDLINE "console=ttyAM0,115200 init=/linuxrc root=/dev/mmcblk0p2 rootfstype=ext3 ro rootwait lcd_panel=lms350 ssp1=mmc line=1 sysrq_always_enabled"
...
int run_linux(char *address, char *cmdline, char *initrd_addr, int initrd_size);
#endif /* __LINUX_H__ */
