...
{
    HW_DRAM_CTL00_WR(0x01010001);    HW_DRAM_CTL01_WR(0x00010000);
    HW_DRAM_CTL02_WR(0x01000000);    HW_DRAM_CTL03_WR(0x00000001);
    HW_DRAM_CTL04_WR(0x00000101);    HW_DRAM_CTL05_WR(0x00000000);
    HW_DRAM_CTL06_WR(0x00010000);    HW_DRAM_CTL07_WR(0x01000001);
    HW_DRAM_CTL09_WR(0x00000001);    HW_DRAM_CTL10_WR(0x07000200);
    HW_DRAM_CTL11_WR(0x00070302);    HW_DRAM_CTL12_WR(0x02020000);
    HW_DRAM_CTL13_WR(0x04040a01);    HW_DRAM_CTL14_WR(0x00000200|ce);
    HW_DRAM_CTL15_WR(0x02040000);    HW_DRAM_CTL16_WR(0x02000000);
    HW_DRAM_CTL17_WR(0x25001506);    HW_DRAM_CTL18_WR(0x1f1f0000);
    HW_DRAM_CTL19_WR(0x027f1a1a);    HW_DRAM_CTL20_WR(0x02051c22);
    HW_DRAM_CTL21_WR(0x00000007);    HW_DRAM_CTL22_WR(0x00080008);
    HW_DRAM_CTL23_WR(0x00200020);    HW_DRAM_CTL24_WR(0x00200020);
    HW_DRAM_CTL25_WR(0x00200020);    HW_DRAM_CTL26_WR(0x000002e6);
    HW_DRAM_CTL29_WR(0x00000020);    HW_DRAM_CTL30_WR(0x00000020);
    HW_DRAM_CTL31_WR(0x00c80000);    HW_DRAM_CTL32_WR(0x00081a3b);
    HW_DRAM_CTL33_WR(0x000000c8);    HW_DRAM_CTL34_WR(0x00004b0d);
    HW_DRAM_CTL36_WR(0x00000101);    HW_DRAM_CTL37_WR(0x00040001);
    HW_DRAM_CTL38_WR(0x00000000);    HW_DRAM_CTL39_WR(0x00000000);
    HW_DRAM_CTL40_WR(0x00010000);    HW_DRAM_CTL08_WR(0x01000000);
}


void init_mddr_mt46h32m16lf_96Mhz(int ce)
{
	HW_DRAM_CTL00_WR(0x01010001); 	HW_DRAM_CTL01_WR(0x00010100); 
	HW_DRAM_CTL02_WR(0x01000101);	HW_DRAM_CTL03_WR(0x00000001);
	HW_DRAM_CTL04_WR(0x00000101);	HW_DRAM_CTL05_WR(0x00000001);
	HW_DRAM_CTL06_WR(0x00010000);	HW_DRAM_CTL07_WR(0x01000001);
	HW_DRAM_CTL09_WR(0x00000001);	HW_DRAM_CTL10_WR(0x07000200);
	HW_DRAM_CTL11_WR(0x00070203);	HW_DRAM_CTL12_WR(0x02020002);
	HW_DRAM_CTL13_WR(0x06070a02);	HW_DRAM_CTL14_WR(0x00000200|ce);
	HW_DRAM_CTL15_WR(0x03050000);	HW_DRAM_CTL16_WR(0x02000000);
	HW_DRAM_CTL17_WR(0x2d000808);	HW_DRAM_CTL18_WR(0x1f1f0000);
	HW_DRAM_CTL19_WR(0x020c1010);	HW_DRAM_CTL20_WR(0x0305101c);
	HW_DRAM_CTL21_WR(0x00000007);	HW_DRAM_CTL22_WR(0x00080008);
	HW_DRAM_CTL23_WR(0x00200020);	HW_DRAM_CTL24_WR(0x00200020);
	HW_DRAM_CTL25_WR(0x00200020);	HW_DRAM_CTL26_WR(0x000002e6);
	HW_DRAM_CTL29_WR(0x00000000);	HW_DRAM_CTL30_WR(0x00000020);
	HW_DRAM_CTL31_WR(0x00000000);	HW_DRAM_CTL32_WR(0x000c1a3b);
	HW_DRAM_CTL33_WR(0x0000000c);	HW_DRAM_CTL34_WR(0x00004b0d);
	HW_DRAM_CTL36_WR(0x00000101);	HW_DRAM_CTL37_WR(0x00040001);
	HW_DRAM_CTL38_WR(0x00400000);	HW_DRAM_CTL39_WR(0x00400040);
	HW_DRAM_CTL40_WR(0x00030000);	HW_DRAM_CTL08_WR(0x01010000);
}
...
void init_mddr_mt46h32m16lf_133Mhz(int ce)
{
	...
	HW_DRAM_CTL13_WR(0x06070a02);	HW_DRAM_CTL14_WR(0x00000200|ce);
	HW_DRAM_CTL15_WR(0x03050000);	HW_DRAM_CTL16_WR(0x02000000);
	HW_DRAM_CTL17_WR(0x2000080a);	HW_DRAM_CTL18_WR(0x1f1f0000);
	HW_DRAM_CTL19_WR(0x020C1010);	HW_DRAM_CTL20_WR(0x0306101c);
	HW_DRAM_CTL21_WR(0x0000000a);	HW_DRAM_CTL22_WR(0x00080008);
	HW_DRAM_CTL23_WR(0x00200020);	HW_DRAM_CTL24_WR(0x00200020);
	HW_DRAM_CTL25_WR(0x00200020);	HW_DRAM_CTL26_WR(0x00000408);
	HW_DRAM_CTL29_WR(0x00000000);	HW_DRAM_CTL30_WR(0x00000020);
	HW_DRAM_CTL31_WR(0x00000000);	HW_DRAM_CTL32_WR(0x0010245f);
	HW_DRAM_CTL33_WR(0x00000010);	HW_DRAM_CTL34_WR(0x00006808);
	HW_DRAM_CTL36_WR(0x00000101);	HW_DRAM_CTL37_WR(0x00040001);
	HW_DRAM_CTL38_WR(0x00400162);	HW_DRAM_CTL39_WR(0x00400040);
	HW_DRAM_CTL40_WR(0x00040000);	HW_DRAM_CTL08_WR(0x01010000);
}
...
void init_ddr_mt46v32m16_133Mhz(int ce)
{
	...
	HW_DRAM_CTL06_WR(0x00010000);	HW_DRAM_CTL07_WR(0x01000001);
	HW_DRAM_CTL09_WR(0x00000001);	HW_DRAM_CTL10_WR(0x07000200);
	HW_DRAM_CTL11_WR(0x00070202);	HW_DRAM_CTL12_WR(0x02020000);
	HW_DRAM_CTL13_WR(0x04040a01);	HW_DRAM_CTL14_WR(0x00000200|ce);
	HW_DRAM_CTL15_WR(0x02040000);	HW_DRAM_CTL16_WR(0x02000000);
	HW_DRAM_CTL17_WR(0x19000f08);	HW_DRAM_CTL18_WR(0x0d0d0000);
	HW_DRAM_CTL19_WR(0x02021313);	HW_DRAM_CTL20_WR(0x02061521);
	HW_DRAM_CTL21_WR(0x0000000a);	HW_DRAM_CTL22_WR(0x00080008);
	HW_DRAM_CTL23_WR(0x00200020);	HW_DRAM_CTL24_WR(0x00200020);
	HW_DRAM_CTL25_WR(0x00200020);	HW_DRAM_CTL26_WR(0x000003f7);
	HW_DRAM_CTL29_WR(0x00000020);	HW_DRAM_CTL30_WR(0x00000020);
	HW_DRAM_CTL31_WR(0x00c80000);	HW_DRAM_CTL32_WR(0x000a23cd);
	HW_DRAM_CTL33_WR(0x000000c8);	HW_DRAM_CTL34_WR(0x00006665);
	HW_DRAM_CTL36_WR(0x00000101);	HW_DRAM_CTL37_WR(0x00040001);
	HW_DRAM_CTL38_WR(0x00000000);	HW_DRAM_CTL39_WR(0x00000000);
	HW_DRAM_CTL40_WR(0x00010000);	HW_DRAM_CTL08_WR(0x01000000);
}
...
#else
#ifdef EMI_96M
	init_ddr_mt46v32m16_96Mhz(CE);
	printf("init_ddr_mt46v32m16_96Mhz\r\n");
#else
//	init_ddr_mt46v32m16_133Mhz(CE);
        init_ddr_W9425G6EH_5_96Mhz(CE);
//	printf("init_ddr_mt46v32m16_133Mhz\r\n");
	printf("init_ddr_W9425G6EH_5_96Mhz\r\n");
#endif
#endif
